...
../SwiftFolderCleaner.xcodeproj  # Xcode project file
```
...
```
/refactor Sources/SwiftFolderCleaner/Scanner.swift
...
/add-tests Sources/SwiftFolderCleaner/Domain/FileNode.swift
```
